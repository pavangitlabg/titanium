...
namespace Data.Models
{
    public class UserModel
    {
        ...
        [RegularExpression("^(?=.*[0-9]+.*)(?=.*[a-zA-Z]+.*)[0-9a-zA-Z]{8,30}$" , ErrorMessage = "Password must contain at least one letter, at least one number, and be longer than eight charaters")] //Password must contain at least one letter, at least one number, and be longer than eight charaters.
        ...
        [Display(Name = "Advanced User")]
        public bool IsAdvancedUser { get; set; }

        [Display(Name = "Administrator")]
        public bool IsAdministrator { get; set; }
        [Display(Name = "Trade Inquiry")]
    ...
    public class UserPasswordModel
    {
        ...
        [DataType(DataType.Password)]
        [RegularExpression("^(?=.*[0-9]+.*)(?=.*[a-zA-Z]+.*)[0-9a-zA-Z]{8,30}$", ErrorMessage = "Password must contain at least one letter, at least one number, and be longer than eight charaters")] 
