...
{
    public class TariffExceptionsModel
    {
        public string _id { get; set; }
        [Display(Name = "Tariff Exceptions ID")]
        ...
        [Display(Name = "ISSB Stored Code")]
        public string ISSB_STORED_CODE { get; set; }
        [Display(Name = "ISSB Stored Legend")]
        ...
        [Display(Name = "Lower VPT")]
        public string LOWER_VPT { get; set; }
        [Display(Name = "Upper VPT")]
        ...
        [Display(Name = "Side of Trade")]
        public string SIDE_OF_TRADE { get; set; }
        [Display(Name = "Tariff Code Table Code")]
