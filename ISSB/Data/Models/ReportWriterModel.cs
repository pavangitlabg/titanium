...
namespace Data.Models
{
    public class ReportWriterModel
    {
        ...
        public List<ReportWriterByMonthModel> GroupByType(List<ReportWriterModel> ReportList)
        {
            ...
            foreach (var Item in ReportList)
            {
                ...
                try
                {
                    ReportWriterByMonthModel f = new ReportWriterByMonthModel();

                    int CaseNumber = 0;
                    if (string.IsNullOrEmpty(Item.TARIFF_CODE) && string.IsNullOrEmpty(Item.MC_GEO) && !string.IsNullOrEmpty(Item.SC_GEO)) { CaseNumber = 1; }
                    if (!string.IsNullOrEmpty(Item.TARIFF_CODE) && !string.IsNullOrEmpty(Item.SC_GEO) && string.IsNullOrEmpty(Item.MC_GEO)) { CaseNumber = 2; }
                    if (string.IsNullOrEmpty(Item.TARIFF_CODE) && string.IsNullOrEmpty(Item.SC_GEO) && !string.IsNullOrEmpty(Item.MC_GEO)) { CaseNumber = 3; }
                    if (!string.IsNullOrEmpty(Item.TARIFF_CODE) && !string.IsNullOrEmpty(Item.MC_GEO) && string.IsNullOrEmpty(Item.SC_GEO)) { CaseNumber = 4; }
                    if (!string.IsNullOrEmpty(Item.TARIFF_CODE) && !string.IsNullOrEmpty(Item.MC_GEO) && !string.IsNullOrEmpty(Item.SC_GEO)) { CaseNumber = 5; }
                    if (!string.IsNullOrEmpty(Item.TARIFF_CODE) && string.IsNullOrEmpty(Item.MC_GEO) && string.IsNullOrEmpty(Item.SC_GEO)) { CaseNumber = 6; }

                    switch (CaseNumber)
                    {
                        case 1:
                            f = GrpList.Find(s => s.SC_GEO.Equals(Item.SC_GEO) && s.SIDE_OF_TRADE.Equals(Item.SIDE_OF_TRADE) && s.YEAR.Equals(Item.YEAR));
                            break;
                        case 2:
                            f = GrpList.Find(s => s.SC_GEO.Equals(Item.SC_GEO) && s.SIDE_OF_TRADE.Equals(Item.SIDE_OF_TRADE) && s.TARIFF_CODE.Equals(Item.TARIFF_CODE) && s.YEAR.Equals(Item.YEAR));
                            break;
                        case 3:
                            f = GrpList.Find(s => s.MC_GEO.Equals(Item.SC_GEO) && s.SIDE_OF_TRADE.Equals(Item.SIDE_OF_TRADE) && s.YEAR.Equals(Item.YEAR));
                            break;
                        case 4:
                            f = GrpList.Find(s => s.MC_GEO.Equals(Item.MC_GEO) && s.SIDE_OF_TRADE.Equals(Item.SIDE_OF_TRADE) && s.TARIFF_CODE.Equals(Item.TARIFF_CODE) && s.YEAR.Equals(Item.YEAR));
                            break;
                        case 5:
                            f = GrpList.Find(s => s.SC_GEO.Equals(Item.SC_GEO) && s.MC_GEO.Equals(Item.MC_GEO) && s.SIDE_OF_TRADE.Equals(Item.SIDE_OF_TRADE) && s.TARIFF_CODE.Equals(Item.TARIFF_CODE) && s.YEAR.Equals(Item.YEAR));
                            break;
                        case 6:
                            f = GrpList.Find(s => s.TARIFF_CODE.Equals(Item.TARIFF_CODE) && s.SIDE_OF_TRADE.Equals(Item.SIDE_OF_TRADE) && s.YEAR.Equals(Item.YEAR));
                            break;
                    }
                    ...
                    if (f == null)
                    {
                        ...
                        for (int i = 1; i <= 12; i++)
                        {
                            ...
                            {
                                case 1:
                                    ValueList = ReportList.Find(s => s.SC_GEO.Equals(Item.SC_GEO) && s.SIDE_OF_TRADE.Equals(Item.SIDE_OF_TRADE) && s.YEAR.Equals(Item.YEAR) && s.MONTH.Equals(i));
                                    break;
                                case 2:
                                    ValueList = ReportList.Find(s => s.SC_GEO.Equals(Item.SC_GEO) && s.SIDE_OF_TRADE.Equals(Item.SIDE_OF_TRADE) && s.TARIFF_CODE.Equals(Item.TARIFF_CODE) && s.YEAR.Equals(Item.YEAR) && s.MONTH.Equals(i));
                                    break;
                                case 3:
                                    ValueList = ReportList.Find(s => s.MC_GEO.Equals(Item.MC_GEO) && s.SIDE_OF_TRADE.Equals(Item.SIDE_OF_TRADE) && s.YEAR.Equals(Item.YEAR) && s.MONTH.Equals(i));
                                    break;
                                case 4:
                                    ValueList = ReportList.Find(s => s.MC_GEO.Equals(Item.MC_GEO) && s.SIDE_OF_TRADE.Equals(Item.SIDE_OF_TRADE) && s.TARIFF_CODE.Equals(Item.TARIFF_CODE) && s.YEAR.Equals(Item.YEAR) && s.MONTH.Equals(i));
                                    break;
                                case 5:
                                    ValueList = ReportList.Find(s => s.SC_GEO.Equals(Item.SC_GEO) && s.MC_GEO.Equals(Item.MC_GEO) && s.SIDE_OF_TRADE.Equals(Item.SIDE_OF_TRADE) && s.TARIFF_CODE.Equals(Item.TARIFF_CODE) && s.YEAR.Equals(Item.YEAR) && s.MONTH.Equals(i));
                                    break;
                                case 6:
                                    ValueList = ReportList.Find(s => s.TARIFF_CODE.Equals(Item.TARIFF_CODE) && s.SIDE_OF_TRADE.Equals(Item.SIDE_OF_TRADE) && s.YEAR.Equals(Item.YEAR) && s.MONTH.Equals(i));
                                    break;
                            }
                            ...
                            if (double.IsInfinity(model.TOTAL_VPT))
                            {
                                model.TOTAL_VPT = 0;
                            }
                        }
    ...
    public class ReportPivotYearModel
    {
        ...
        public string KEY { get; set; }
        [JsonProperty("2030")]
        public string Y2030 { get; set; }
        [JsonProperty("2029")]
        public string Y2029 { get; set; }
        [JsonProperty("2028")]
        public string Y2028 { get; set; }
        [JsonProperty("2027")]
        public string Y2027 { get; set; }
        [JsonProperty("2026")]
        public string Y2026 { get; set; }
        [JsonProperty("2025")]
        ...
        [JsonProperty("2019")]
        public string Y2019 { get; set; }
        [JsonProperty("2018")]
        public string Y2018 { get; set; }
        [JsonProperty("2017")]
        public string Y2017 { get; set; }
        [JsonProperty("2016")]
        public string Y2016 { get; set; }
        [JsonProperty("2015")]
        ...
        [JsonProperty("1999")]
        public string Y1999 { get; set; }
        [JsonProperty("1998")]
        public string Y1998 { get; set; }
        [JsonProperty("1997")]
        public string Y1997 { get; set; }
        [JsonProperty("1996")]
        public string Y1996 { get; set; }
        [JsonProperty("1995")]
        public string Y1995 { get; set; }
        [JsonProperty("1994")]
        public string Y1994 { get; set; }
        [JsonProperty("1993")]
        public string Y1993 { get; set; }
        [JsonProperty("1992")]
        public string Y1992 { get; set; }
        [JsonProperty("1991")]
        public string Y1991 { get; set; }
        [JsonProperty("1990")]
        public string Y1990 { get; set; }
