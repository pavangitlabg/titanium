/*
    ISSB/Models/ReportEngineModel.cs

    reporting engine model
*/
...
namespace ISSB.Models
{
    ...
    public class ReportEngineModel
    {
        ...
        public string Serialised { get { return JsonConvert.SerializeObject(Data); } }
        ...
        public int Separately { get { return GetSeparately(); } }
        ...
        public int AllSeparately { get { return GetAllSeparately(); } }

        /// <summary>label member path</summary>

        public string LabelMemberPath { get { return GetLabelMemberPath(); } }
        ...
        private int GetSeparately()
        {
            ...
            if (Search.IncludePorts && Search.PortGrouping == GroupingOption.Separately) separately = separately == 0 ? 4 : -1;
            ...
            if (Search.GroupByYear && !Search.GroupByQuarter && !Search.GroupByMonth) separately = separately == 0 ? 64 : -1;
        ...
        public GridColumnBuilder<ReportOutModel> Columns(GridColumnBuilder<ReportOutModel> column)
        {
            ...
            GridWidth = iWidth.ToString() + "%";

            return column;
        }

        internal object Columns() { throw new NotImplementedException(); }
        ...
        public async Task ConvertToCurrency(string currency)
        {
            ...
            if (!SelectedCurrency.Equals("GBP"))
            {
                ...
                {
                    var ReportDate = Item.YEAR.ToString() + "-" + Item.MONTH.ToString().PadLeft(2,'0') + "-01";
