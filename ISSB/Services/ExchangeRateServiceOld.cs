    ...
    public class ExchangeRateServiceOld
    {
        public async Task<List<ExchangeModel>> GetRates()
        {
            ...
            foreach (var Item in results)
            {
                ...
                {
                    var cModel = new ExchangeListModel { Country = lItem.Country, Currency = lItem.Currency, Value = lItem.Value };
                    cList.Add(cModel);
                }
        ...
        public async Task<bool> AddRates(List<ExchangeModel> modelList)
        {
            ...
            foreach (var Item in modelList)
            {
                ...
                catch (Exception e)
                {
                    ...
                    var eModel = new ErrorModel { Code = "500", Class = "ExchangeRateService Line 89", ErrorMessage = e.Message };
