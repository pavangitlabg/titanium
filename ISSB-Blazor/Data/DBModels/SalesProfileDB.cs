...
public class SalesProfileDB
{
    ...
    public BsonDateTime DATE_AC_OPENED { get; set; }
    public BsonDateTime DATE_ACCOUNT_OPENED { get; set; }
    public BsonDateTime DATE_NEXT_CREDIT { get; set; }
    public BsonDateTime DATE_LAST_CREDIT { get; set; }
    ...
    public BsonDateTime DATE_CREDIT_APPLIED { get; set; }
    public BsonDateTime DATE_CREDIT_RECEIVED { get; set; }
    public int OVERRIDE_TAX_CODE { get; set; }
    public BsonDateTime LAST_PAYMENT_DATE { get; set; }
    public BsonDateTime FIRST_INV_DATE { get; set; }
    public int AVERAGE_PAY_DAYS { get; set; }
    public BsonDateTime LAST_INV_DATE { get; set; }
    ...
    public BsonDateTime LAST_UPDATED { get; set; }
