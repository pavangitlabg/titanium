...
public class ClientDataImportModel
{
    ...
    [Display(Name = "..")] public string Address2 { get; set; }

    [Display(Name = "..")] public string Address3 { get; set; }

    [Display(Name = "Region")] public string Address4 { get; set; }

    [Display(Name = "Country")] public string Address5 { get; set; }
    ...
    [Display(Name = "Fax Number")] public string Fax { get; set; }

    [Display(Name = "Web Site Address")] public string WebSite { get; set; }

    [Display(Name = "Notes / Memo")] public string Notes { get; set; }
    ...
    [Display(Name = "Region Code")] public string RegionCode { get; set; }

    [Display(Name = "Country Mapping")] public bool CountryMapping { get; set; }

    [Display(Name = "Import Type")] public string ImportType { get; set; }

    [Display(Name = "Source Country GEO")] public string SourceGEO { get; set; }
