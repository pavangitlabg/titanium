...
public class AssetModel
{
    ...
    [Display(Name = "Serial Number")] public string SERIAL_NO { get; set; }

    [Display(Name = "Manufacturer")] public string MANUFACTURER { get; set; }

    [Display(Name = "Model")] public string MODEL_TYPE { get; set; }

    [Display(Name = "Purchased Date")]
    [DataType(DataType.Date)]
    public DateTime PURCHASE_DATE { get; set; }

    [Display(Name = "Value")] public double VALUE { get; set; }
    ...
    [Display(Name = "Checked By")] public string CHECKED_BY { get; set; }
