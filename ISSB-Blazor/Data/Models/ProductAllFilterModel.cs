...
{
    [JsonIgnore] public string _id { get; set; }

    [Display(Name = "Id")] public int Idx { get; set; }

    [Display(Name = "Sort Order")] public int SortOrder { get; set; }

    [Display(Name = "Tariff Code")] public string TariffCode { get; set; }

    [Display(Name = "Name")] public string Name { get; set; }

    [Display(Name = "Cost")] public double Cost { get; set; }
}
