...
public class ProductService
{
    ...
    public async Task<ProductAllFilterModel> GetProductsByTariffCode(string code)
    {
        ...
        var model = new ProductAllFilterModel
        {
            _id = Item._id.ToString(), Idx = Item.Idx, SortOrder = Item.SortOrder, TariffCode = Item.TariffCode,
    ...
    public async Task<List<ProductBroadFilterModel>> GetAllBroadProducts()
    {
        ...
        foreach (var Item in results)
        {
            ...
            {
                var iModel = new ProductBroadFilterItemModel
                {
                    Name = It.Name, Sort = It.Sort, TariffCode = It.TariffCode,
                    Description = It.TariffCode + " - " + It.Name
                };
    ...
    public async Task<List<string>> GetAllSteel()
    {
        ...
        foreach (var It in Item.Items) iList.Add(It.TariffCode);
    ...
    public async Task<List<ProductMedumFilterModel>> GetAllMedumProducts()
    {
        ...
        foreach (var Item in results)
        {
            ...
            foreach (var It in Item.Items)
            {
                var iModel = new ProductMedumFilterItemModel
                {
                    Name = It.Name, Sort = It.Sort, TariffCode = It.TariffCode,
                    Description = It.TariffCode + " - " + It.Name
                };
    ...
    public async Task<bool> SaveBroad(ProductBroadFilterModel model)
    {
        ...
        {
            var iModel = new ProductBroadFilterItemDB
                { TariffCode = modelItem.TariffCode, Name = modelItem.Name, Sort = modelItem.Sort };
            iList.Add(iModel);
        }
    ...
    public async Task<ProductMedumFilterDB> SaveMedum(ProductMedumFilterModel model)
    {
        ...
        foreach (var modelItem in model.Items)
        {
            var iModel = new ProductMedumFilterItemDB
                { TariffCode = modelItem.TariffCode, Name = modelItem.Name, Sort = modelItem.Sort };
            iList.Add(iModel);
        }
    ...
    public async Task<ProductBroadFilterDB> Delete(ProductBroadFilterModel model)
    {
        ...
        {
            var pmodel = new ProductBroadFilterItemDB
                { TariffCode = mItem.TariffCode, Name = mItem.Name, Sort = mItem.Sort };
            pList.Add(pmodel);
        }
    ...
    public async Task<ProductMedumFilterDB> DeleteMedum(ProductMedumFilterModel model)
    {
        ...
        foreach (var mItem in model.Items)
        {
            var pmodel = new ProductMedumFilterItemDB
                { TariffCode = mItem.TariffCode, Name = mItem.Name, Sort = mItem.Sort };
            pList.Add(pmodel);
        }
