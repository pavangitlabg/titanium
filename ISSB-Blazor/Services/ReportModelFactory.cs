...
{
    private readonly List<ReportOutModel> reportList; // model list
    ...
    {
        reportList = new List<ReportOutModel>();
    }
    ...
    public IQueryable Queryable => reportList.AsQueryable();
    ...
    public void Add(BsonDocument document, SearchModel criteria, int Id)
    {
        ...
        var model = new ReportOutModel
        {
            ...
            TARIFF_CODE = ProductDetail == ProductDetailOption.Long
                ? tariff == null ? null : tariff.SOURCE_COUNTRY_TARIFF_CODE
                : id.H_TARIFF,
            ...
            SIDE_OF_TRADE = id.SIDE_OF_TRADE.Equals("E") ? "Export" :
                id.SIDE_OF_TRADE.Equals("I") ? "Import" : id.SIDE_OF_TRADE,
            PORT_ID = id.PORT_ID,
