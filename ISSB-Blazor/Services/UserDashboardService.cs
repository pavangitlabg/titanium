...
public class UserDashboardService
{
        ...
        foreach (var modelItem in model.Items)
        {
            ...
            if (modelItem.Query1 != null)
                if (modelItem.Query1.SourceCountryGEOs != null)
                {
                    ...
                    if (modelItem.Query1.Ports == null) modelItem.Query1.Ports = new List<DashBoardQueryPortModel>();
            ...
            if (modelItem.Query2 != null)
                if (modelItem.Query2.SourceCountryGEOs != null)
                {
                    ...
                    var portList = new List<DashBoardQueryPortDB>();
                    if (modelItem.Query2.Ports == null) modelItem.Query2.Ports = new List<DashBoardQueryPortModel>();
            ...
            if (modelItem.Query3 != null)
                if (modelItem.Query3.SourceCountryGEOs != null)
                {
                    ...
                    var portList = new List<DashBoardQueryPortDB>();
                    if (modelItem.Query3.Ports == null) modelItem.Query3.Ports = new List<DashBoardQueryPortModel>();
            ...
            if (modelItem.Query4 != null)
                if (modelItem.Query4.SourceCountryGEOs != null)
                {
                    ...
                    var portList = new List<DashBoardQueryPortDB>();
                    if (modelItem.Query4.Ports == null) modelItem.Query4.Ports = new List<DashBoardQueryPortModel>();
    ...
    public async Task<UserDashboardModel> GetCurrentDesignDashboard(string UserIdentityName, bool bDesignMode)
    {
        ...
        var filter = Builders<UserDashboardDB>.Filter.Eq(x => x.UserIdentityName, UserIdentityName) &
                     Builders<UserDashboardDB>.Filter.Eq(z => z.bDesignMode, bDesignMode);
    ...
    public async Task<UserDashboardModel> GetCurrentDashboardByID(string Id, bool bStatus)
    {
        ...
        var filter = Builders<UserDashboardDB>.Filter.Eq(x => x._id, RecordId) &
                     Builders<UserDashboardDB>.Filter.Eq(z => z.bDesignMode, bStatus);
    ...
    public async Task<List<UserDashboardModel>> GetUserDashboards(string User)
    {
        ...
        var filter = Builders<UserDashboardDB>.Filter.Eq(x => x.UserIdentityName, User) &
                     Builders<UserDashboardDB>.Filter.Eq(z => z.bDesignMode, false);
